...
//
//              NIC with basic monitor support
//
///////////////////////////////////////////////////////////////////////////////
...
`define MONITOR_BLOCK_ADDR_WIDTH        17
`define MONITOR_REG_ADDR_WIDTH          6
...
`define MONITOR_BLOCK_ADDR        17'h00012
...
`define MONITOR_STARTING            6'h0
`define MONITOR_IP_ID_NUMBER        6'h1
`define MONITOR_TIMESTAMP_LOW       6'h2
`define MONITOR_TIMESTAMP_HIGH      6'h3
`define MONITOR_NTP_TIMESTAMP_HIGH  6'h4
`define MONITOR_NTP_TIMESTAMP_LOW   6'h5
...
`define MAC_GRP_TIMESTAMP_BAD_LOW               16'hd
`define MAC_GRP_TIMESTAMP_BAD_HIGH              16'he
