...
# Description: NIC with basic crypto support
#
#############################################################

package reg_defines_crypto_nic;
...
sub DEVICE_PROJ_DIR ()  { "crypto_nic"; }
sub DEVICE_PROJ_NAME () { "Crypto NIC"; }
sub DEVICE_PROJ_DESC () { "NIC with basic crypto support"; }
...
sub CRYPTO_BASE_ADDR ()        { 0x2000000; }
...
sub CRYPTO_KEY_REG ()    { 0x2000000;}
sub CRYPTO_KEY2_REG ()   { 0x2000004;}
sub CRYPTO_KEY3_REG ()   { 0x2000008;}
