...
#
# Project: Monitor NIC (monitor_nic)
# Description: NIC with basic monitor support
#
#############################################################

package reg_defines_monitor_nic;
...
@EXPORT = qw(
                ...
                MAC_GRP_0_TIMESTAMP_BAD_LOW_REG
                MAC_GRP_0_TIMESTAMP_BAD_HIGH_REG
                ...
                MAC_GRP_1_TIMESTAMP_BAD_LOW_REG
                MAC_GRP_1_TIMESTAMP_BAD_HIGH_REG
                ...
                MAC_GRP_2_TIMESTAMP_BAD_LOW_REG
                MAC_GRP_2_TIMESTAMP_BAD_HIGH_REG
                ...
                MAC_GRP_3_TIMESTAMP_BAD_LOW_REG
                MAC_GRP_3_TIMESTAMP_BAD_HIGH_REG
                ...
                IN_ARB_STATE_REG
                MONITOR_STARTING_REG
                MONITOR_IP_ID_NUMBER_REG
                MONITOR_TIMESTAMP_LOW_REG
                MONITOR_TIMESTAMP_HIGH_REG
                MONITOR_NTP_TIMESTAMP_HIGH_REG
                MONITOR_NTP_TIMESTAMP_LOW_REG
...
sub DEVICE_PROJ_DIR ()  { "monitor_nic"; }
sub DEVICE_PROJ_NAME () { "Monitor NIC"; }
sub DEVICE_PROJ_DESC () { "NIC with basic monitor support"; }
...
# ===== File: projects/monitor_nic/include/ethernet_mac.xml =====
...
sub MONITOR_BASE_ADDR ()         { 0x2001200; }
...
sub MAC_GRP_0_TIMESTAMP_BAD_LOW_REG ()                { 0x0600034;}
sub MAC_GRP_0_TIMESTAMP_BAD_HIGH_REG ()               { 0x0600038;}
...
sub MAC_GRP_1_TIMESTAMP_BAD_LOW_REG ()                { 0x0640034;}
sub MAC_GRP_1_TIMESTAMP_BAD_HIGH_REG ()               { 0x0640038;}
...
sub MAC_GRP_2_TIMESTAMP_BAD_LOW_REG ()                { 0x0680034;}
sub MAC_GRP_2_TIMESTAMP_BAD_HIGH_REG ()               { 0x0680038;}
...
sub MAC_GRP_3_TIMESTAMP_BAD_LOW_REG ()                { 0x06c0034;}
sub MAC_GRP_3_TIMESTAMP_BAD_HIGH_REG ()               { 0x06c0038;}
...
# Description: Registers for Monitor Module
# File: projects/monitor_nic/include/monitor.xml
sub MONITOR_STARTING_REG ()             { 0x2001200;}
sub MONITOR_IP_ID_NUMBER_REG ()         { 0x2001204;}
sub MONITOR_TIMESTAMP_LOW_REG ()        { 0x2001208;}
sub MONITOR_TIMESTAMP_HIGH_REG ()       { 0x200120c;}
sub MONITOR_NTP_TIMESTAMP_HIGH_REG ()   { 0x2001210;}
sub MONITOR_NTP_TIMESTAMP_LOW_REG ()    { 0x2001214;}
